...
class SourceRegistryTest(unittest.TestCase):
    ...
    def test_default_registry_declares_confirmed_master_watch_scope(self):
        ...
        self.assertFalse(any("municipality" in entry.source_layer for entry in registry.entries))
    ...
    def test_registry_specs_capture_official_materials_with_metadata(self):
        ...
        self.assertFalse(any("city." in spec.canonical_url for spec in specs))
